...
# ------------------------------------------------------------------------------------- #
def channel2detector(ch):
    if (64 <= ch) and (ch<=127): # KETEK 3x3 - 1
        detector = 12;
    elif (128 <= ch) and (ch<=192): # KETEK 3x3 - 2
        detector = 3;
    elif (895 <= ch) and (ch<=1023): # SensL 6x6 - 1
        detector = 6;
    elif (767 <= ch) and (ch<=895): # SensL 6x6 - 2
        detector = 9;
    else:
        detector = 0; # unknown
    return detector
